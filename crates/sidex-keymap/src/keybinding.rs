...
impl fmt::Display for Key {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let s = match self {
            ...
            Self::Insert => "Insert", Self::Pause => "Pause",
            Self::CapsLock => "CapsLock", Self::NumLock => "NumLock",
            Self::ScrollLock => "ScrollLock",
            Self::Minus => "-", Self::Equal => "=",
            Self::BracketLeft => "[", Self::BracketRight => "]",
            Self::Backslash => "\\", Self::Semicolon => ";",
            Self::Quote => "'", Self::Backquote => "`",
            Self::Comma => ",", Self::Period => ".",
            Self::Slash => "/", Self::ContextMenu => "ContextMenu",
...
impl FromStr for Key {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_ascii_lowercase().as_str() {
            ...
            "d" => Ok(Self::D), "e" => Ok(Self::E), "f" => Ok(Self::F),
            "g" => Ok(Self::G), "h" => Ok(Self::H), "i" => Ok(Self::I),
            "j" => Ok(Self::J), "k" => Ok(Self::K), "l" => Ok(Self::L),
            "m" => Ok(Self::M), "n" => Ok(Self::N), "o" => Ok(Self::O),
            "p" => Ok(Self::P), "q" => Ok(Self::Q), "r" => Ok(Self::R),
            "s" => Ok(Self::S), "t" => Ok(Self::T), "u" => Ok(Self::U),
            "v" => Ok(Self::V), "w" => Ok(Self::W), "x" => Ok(Self::X),
            "y" => Ok(Self::Y), "z" => Ok(Self::Z),
            "0" => Ok(Self::Digit0), "1" => Ok(Self::Digit1),
            "2" => Ok(Self::Digit2), "3" => Ok(Self::Digit3),
            "4" => Ok(Self::Digit4), "5" => Ok(Self::Digit5),
            "6" => Ok(Self::Digit6), "7" => Ok(Self::Digit7),
            "8" => Ok(Self::Digit8), "9" => Ok(Self::Digit9),
            "f1" => Ok(Self::F1), "f2" => Ok(Self::F2), "f3" => Ok(Self::F3),
            "f4" => Ok(Self::F4), "f5" => Ok(Self::F5), "f6" => Ok(Self::F6),
            "f7" => Ok(Self::F7), "f8" => Ok(Self::F8), "f9" => Ok(Self::F9),
            "f10" => Ok(Self::F10), "f11" => Ok(Self::F11), "f12" => Ok(Self::F12),
            "enter" | "return" => Ok(Self::Enter),
            "escape" | "esc" => Ok(Self::Escape),
            "tab" => Ok(Self::Tab), "space" => Ok(Self::Space),
            ...
            "home" => Ok(Self::Home), "end" => Ok(Self::End),
            "pageup" => Ok(Self::PageUp), "pagedown" => Ok(Self::PageDown),
            "insert" => Ok(Self::Insert), "pause" => Ok(Self::Pause),
            "capslock" => Ok(Self::CapsLock), "numlock" => Ok(Self::NumLock),
